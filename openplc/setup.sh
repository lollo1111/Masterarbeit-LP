...
# register the stop_openplc function to be executed when the SIGTERM signal is received
trap stop_openplc SIGTERM

SQL_SCRIPT="INSERT INTO Programs (Name, Description, File, Date_upload) VALUES ('Factory I/O Function Block Diagram', 'PLC Program for the Simulation', 'automation.st', strftime('%s', 'now'));"
